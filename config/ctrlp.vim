...
let g:ctrlp_extensions = ['tag', 'buffertag', 'quickfix', 'dir', 'rtscript', 'undo', 'line', 'changes', 'yankring', 'cmdline', 'menu']
...
nnoremap <silent> <leader>tr :call <SID>call_ctrlp_extension('rtscript')<cr>
